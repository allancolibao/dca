                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <textarea type="text" class="form-control" name="sec_02_21" id="sec_02_21" rows="4">{{ old('sec_02_21') }}</textarea>
                                                    </td>                                                  
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <textarea type="text" class="form-control" name="sec_02_22" id="sec_02_22" rows="4">{{ old('sec_02_22') }}</textarea>
                                                    </td>                                                  
                                                </tr>
                                            </tbody>
                                        </table>
